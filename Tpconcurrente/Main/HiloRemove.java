...
public class HiloRemove implements Runnable {
	int cont;
	int strLen;
	int cantOperaciones;
	long tiempoInicio;
	Lista lista;
	public HiloRemove(int cantOperaciones, Lista lista, long tiempoInicio, int strLen) {
		this.cont = 0;
	...
	public synchronized void run(){
		...
		String msg = String.format("Hilo 'remove' con %d operaciones y strLen=%d demoro %d ms", cantOperaciones, strLen, System.currentTimeMillis()-tiempoInicio);
